(function (global, factory) {
	...
	var KeycloakAuthorization = function (keycloak, options) {
	    ...
	    if (typeof es6Promise_min.exports.Promise !== "undefined" && es6Promise_min.exports.Promise.toString().indexOf("[native code]") !== -1) {
	        this.ready = new es6Promise_min.exports.Promise(function (res, rej) {
	            resolve = res;
	            reject = rej;
	        });
	    }
